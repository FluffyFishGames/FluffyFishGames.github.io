...
window.onload = function()
{
	...
	el.id = "update";
	el.innerHTML = "<h2>Too bad!</h2><p>The DarkMode is now invite-only. <br />Join the TeamSpeak at souldrinker.de to get in touch with us and get an invite. <br /><br />The only other option is to pay for the access. Currently there is no payment solution to do so. Just ask on the TeamSpeak.<br /><br />Do you want to thank the people responsible for this?<br />Go to the following TeamSpeak 81.7.8.184 and thank them yourself for publishing hate speech. :)<img src=\"https://lh3.googleusercontent.com/-J0DBZHrYkGA/UoJsytwH7rI/AAAAAAAC_a4/CGvUdJz9Mcg/w640-h400-p-k/Vault_Boy.png\">";
