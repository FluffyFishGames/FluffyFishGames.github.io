...
window.onload = function()
{
	...
	el.id = "update";
	el.innerHTML = "<h2>Too bad!</h2><p>The DarkMode is now <strong>invite-only</strong>. <br />Join the TeamSpeak at souldrinker.de to get in touch with us and get an invite. <br /><br />The only other option is to pay for the access. Currently there is no payment solution to do so. Just ask on the TeamSpeak.<br /><br /><strong>Do you want to thank the people responsible for this?</strong><br />Go to the following TeamSpeak <br />81.7.8.184<br/> and thank them yourself for publishing hate speech. :)<img src=\"https://lh3.googleusercontent.com/-J0DBZHrYkGA/UoJsytwH7rI/AAAAAAAC_a4/CGvUdJz9Mcg/w640-h400-p-k/Vault_Boy.png\">";
	document.body.appendChild(el);
}
window.broadcasterThemes = {"14793089":"werwolf","14484509":"kuhlmann","12681330":"drachenlord","8911994":"ml"};
...
{
 'background-color': [".left-panel", ".chat-mention", "#playersystem", "div div.sidebar-header", ".volume-background", "#chatcomments", "#globalchatcomments"]
},
{
 'background-color': [".leaderboard .lb-cell", ".leaderboard-lists .mini-scroll", "#sidebar-container .sidebar-header .tab-icon.selected", "#main .main-left .channel-menu-content", ".main-content-right", ".result", "#sidebar-container .sidebar-header", ".list-group-item", "#settinguppanel", ".modal-footer", ".tab-icon.selected","#topfan-slider",".level-bar","button.next-fan", "button.prev-fan","div.settings-page","div.main-player",".end-of-broadcast-container","div.mini-player","div#chatinput","input","textarea",".editor",".comment-area",".comment-area.form-control",".fan-mail-widget","#sidebar-container",".user-progress-bar",".guest-optin"],
 'border-color': [".chat-mention", ".d_content", ".selectUIInput", ".broadcast-summary", ".modal-footer", ".navbar-content .notifications .dropdown-menu .list>*", "ul.dropdown-menu li"]
},
{
 'background-color': [".search-title", "#sharepanel", "#momentpanel", ".comment-container", ".moment-container", ".leaderboard .lb-heading", "#sidebar-container .sidebar-header .tab-icon", "#leftsidebar .panel-title", "div #leftsidebar div a:hover",".newFooter, a.activity:hover", ".dropdown-menu", ".buybars-modal .panel-two", ".buybars-modal .panel-four", ".verifications-modal .panel-two", ".verifications-modal .panel-four", ".buybars-modal .content", ".verifications-modal .content", ".gifttray-premium", ".modal-body", ".comment-container", ".fans-tab-fan", ".user-summary", ".stats-container", ".navbar", ".social-panel",".profile-summary-wrapper .profile-summary","div.audience-summary.refresh","ul.dropdown-menu","ul.list li","ul.list",".d_content",".selectUIInput",".eob-header",".guest-preview"],
 'border-color': ["#playerheader", "#sidebar-container .sidebar-header", "#sidebar-container .sidebar-header .tab-icon", "#main .main-left .channel-menu-content", ".main-content-right", ".result", "#sidebar-container", "div.audience-summary", ".guest-nav", ".modal-header", "div.topfan-slider-divider", "#guestpanel .guest", "div#chatinput", "div.main-player", "div.mini-player"],
 'color': [".ynicon.ynicon-carrot-up", ".ynicon.ynicon-carrot-dwn", ".d_arrow.ynicon.ynicon-carrot-dwn"]
},
{
 'background-color': [".main-content.main-async .main-content-left ul.nav", "#addSession", ".buybars-modal .item:hover", ".verifications-modal .item:hover", ".buybars-modal .popular", ".navbar-content .user-menu .dropdown-menu .user", "ul li a:hover", "ul.list li:hover", ".searchResult:hover", "ul.dropdown-menu li.active", "ul.dropdown-menu li:hover", "ul.dropdown-menu li:active", ".mini-scroll::-webkit-scrollbar-thumb"],
 'color': [".user-menu .ynicon.ynicon-carrot-up", "#sidebar-container #chatinput .selfie-container", "#sidebar-container .selfie-container .ynicon-icon-selfie"],
 'border-color': ["#leftsidebar .panel-title", "legend", "#main .main-left .channel-menu-content", "#playersystem", "textarea", ".comment-area.form-control", ".comment-area", ".line-spacing"],
},
{
 'border-color': [".modal-content .actions", ".social-panel", ".navbar", ".tab-header.active", ".tab-header:hover", ".end-of-broadcast-container .detail-container"]
},
{
 'background-color': ["div #leftsidebar div a.active", ".user-progress-value",".chiclet",".thumbnail-placeholder",".total-progress",".selfie-chat-view .semi-prog-2", ".selfie-chat-view .semi-prog-3", "button.btn-primary", "div button.edit-profile", ".explore_more", ".settings-link", ".alert", "div.typeahead-container .tag", ".connect", ".nav-pills li a", ".total-views", ".comment-actions button.btn-cancel", ".searchResult-more", ".end-of-broadcast-container .social-panel .title", ".end-of-broadcast-container .your-stats", ".volume-foreground", "button.btn-fan"],
 'color': ["a", ".ynicon.ynicon-icon-check", ".ynbar.ynicon.ynicon-icon-bar", ".yncoin.ynicon.ynicon-coins", ".main-content.main-async .main-content-left .social-alert .ynicon-carrot-up", ".ynicon-broadcast"],
 'border-color': [".social-panel", ".tab-header.active", ".tab-header:hover", ".end-of-broadcast-container .detail-container"]
},
{
 'background-color': [".nav-pills li a:hover"],
 'border-color': ["button.btn-primary", "div button.edit-profile", ".explore_more", ".settings-link", ".alert", "div.typeahead-container .tag, .connect", ".nav-pills li a", ".total-views", ".comment-actions button.btn-cancel", ".searchResult-more", "button.btn-fan"]
},
{
 'background-color': ["div div button.btn-fanned", "button.btn-cancel"]
},
{
 'border-color': ["div div button.btn-fanned", "button.btn-cancel"]
},
{
 'color': [":placeholder-shown", ":-ms-input-placeholder", "::-moz-placeholder", ":-moz-placeholder", "::-webkit-input-placeholder", "legend", "input:placerholder-shown", "textarea:placeholder-shown"]	
},
{
 'color':[".navbar-content .user-menu .dropdown-menu li .ynicon", ".result .thumb a", "input", "h1", "textarea, .comment-area.form-control", "button.btn-cancel", "button.btn-primary", "div button.edit-profile", ".explore_more", ".settings-link", ".alert", "div.typeahead-container .tag", ".connect", ".nav-pills li a", ".total-views", ".comment-actions button.btn-cancel", ".searchResult-more", "span", "div", "ul.dropdown-menu li a"],
}
];

var colorsCSS = "";
var streamerCSS = {};
var getStreamerCSS = function(key)
{
	if (streamerCSS[key] == null)
	{
		...
		if (colors[key] != null)
		{
			for (var col = 0; col < colors[key].length; col++)
			{
				...
				{
					var sll = "";
					for (var k = 0; k < selectors[col][styleKey].length; k++)
					{
						var sel = selectors[col][styleKey][k];
...
var streamerStyle = document.createElement("style");
streamerStyle.type = 'text/css';
head.appendChild(streamerStyle);
var hearts = [];
var heartsCount = 50;
var heartsInterval = -1;
var endML = function()
{
...
var startML = function()
{
	if (heartsInterval == -1)
	{
		for (var i = 0; i < heartsCount; i++)
		{
			...
			heart.src = "https://fluffyfishgames.github.io/img/streamers/ml.png";
			document.body.appendChild(heart);
			hearts.push({'el':heart, 'phase':Math.random(), 'speed': 0.5 + Math.random() * 0.1, 'x': Math.random(), 'off':Math.random() * 6});
		}
		heartsInterval = setInterval(function(){
			for (var i = 0; i < hearts.length; i++)
			{
				hearts[i].phase += hearts[i].speed * 0.01;
				hearts[i].el.style.top = (window.innerHeight - hearts[i].phase * (window.innerHeight + 70)) + "px";
				hearts[i].el.style.left = -50 + ((window.innerWidth +100) * hearts[i].x + Math.cos(hearts[i].phase * 5 + hearts[i].off) * 30) + "px";
				if (hearts[i].phase >= 1)
				{
					hearts[i].x = Math.random();
					hearts[i].phase = 0;
				}
			}
		}, 50);
...
window.setStreamerID = function(streamerID)
{
	...
	{
		var sCSS = getStreamerCSS(window.broadcasterThemes[streamerID]);
		if (streamerStyle.styleSheet){
			streamerStyle.styleSheet.cssText = sCSS;
		} else {
			streamerStyle.innerText = "";
			streamerStyle.appendChild(document.createTextNode(sCSS));
		}
		...
		document.body.id = "default";
		if (streamerStyle.styleSheet){
			streamerStyle.styleSheet.cssText = "";
		} else {
			streamerStyle.innerText = "";
		}
	}
...
var colorsCSS = getStreamerCSS("default");

var styleText = colorsCSS+window.layoutCSS;
